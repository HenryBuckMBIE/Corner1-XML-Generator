...
public class InputScreen {
		...
		private void initialize() {
			...
			lblAsterix2.setBounds(100, 580, 300, 15);
	        ...
	        payloadButton.setBounds(800, 550, 200, 15);
			frame.getContentPane().add(payloadButton);
			fullN2SButton.setBounds(800, 565, 200, 15);
			frame.getContentPane().add(fullN2SButton);			
			fullS2NButton.setBounds(800, 580, 200, 15);
			...
			btnCreateXML.setBounds(500, 550, 200, 45);
